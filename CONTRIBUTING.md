...
- 测试：`tests/smoke_test.py`、`tests/deploy_smoke_test.py`、`tests/doctor_test.py`、`tests/setup_test.py` 覆盖新场景
...
2. 本地跑一遍测试：`python3 tests/deploy_smoke_test.py`（应输出 `DEPLOY SMOKE PASS`）、`python3 tests/smoke_test.py`（应输出 `SMOKE PASS`）、`python3 tests/doctor_test.py`（应输出 `DOCTOR TEST PASS`）、`python3 tests/setup_test.py`（应输出 `SETUP TEST PASS`）
